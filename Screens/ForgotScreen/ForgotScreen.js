    ...
    return (
        <SafeAreaView>
            ...
            <View style={style.view}>
                <Header title="Forgot" titleBold="Password" />
                ...
                <View style={style.form}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('Verification')} style={style.button}><Text style={style.btnText}>Forgot Password</Text></TouchableOpacity>
